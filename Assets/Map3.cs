...
public class Map3 : MonoBehaviour {
    ...
    void Update() {
        ...
        if (step == 0) {
            if (this.touyamaomoko.GetComponent<RectTransform>().localPosition.x <= -1.72f) {
                this.moveTo1();
            } else {
        ...
        if (step == 1) {
            if (this.touyamaomoko.GetComponent<RectTransform>().localPosition.y <= 0.32f) {
                this.moveTo2();
            } else {
                SceneManager.LoadScene("buttle");
        ...
        if (step == 2) {
            if (this.touyamaomoko.GetComponent<RectTransform>().localPosition.y >= -1.45) {
                this.moveTo3();
            } else {
                SceneManager.LoadScene("buttle");
