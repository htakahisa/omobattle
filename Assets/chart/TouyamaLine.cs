...
public class TouyamaLine : MonoBehaviour
{
    ...
    private float getAddPrice() {
        ...
        if (Random.Range(1, 5) == 3) {
            add = Random.Range(-20, 100);
        } else if (Random.Range(1, 8) == 2) {
            add = Random.Range(-200, 50);
        } else { 
            add = Random.Range(-20, 20);
        }
    ...
    private void showText() {
        GameObject.Find("TouyamaText").GetComponent<Text>().text = "とうやま書店: " + price;
    }
