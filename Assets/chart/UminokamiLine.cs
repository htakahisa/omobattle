...
public class UminokamiLine : MonoBehaviour {
    ...
    private float getAddPrice() {
        ...
        if (Random.Range(1, 20) == 3) {
            add = Random.Range(-200, 0);
        } else {
            add = Random.Range(-50, 60);
        }
    ...
    private void showText() {
        GameObject.Find("UminokamiText").GetComponent<Text>().text = " 海の神水産: " + price;
    }
